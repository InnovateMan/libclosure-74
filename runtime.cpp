...
// __sync_bool_compare_and_swap 是 GCC 内建的原子操作函数， wapLong(_Old, _New, _Ptr) __sync_bool_compare_and_swap(_Ptr, _Old, _New)
...
/*******************************************************************************
Internal Utilities
 *****************************************************************************执行CAS操作，比较 _Ptr 和 _Old。 如果相等就将 _New 放到 _Ptr 中，并且返回true，否则返回false
 #define OSAtomicCompareAndS***/
